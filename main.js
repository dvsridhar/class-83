...
function my_touchmove(e)
{
    ...
    ctx.moveTo(last_postion_of_touch_x, last_postion_of_y);

    console.log("Current position of x and y coordinates = ");
    console.log("x = " + current_postion_of_touch_x +"y = " + current_position_of_touch_y);
    ctx.lineTo(current_positon_of_touch_x, current_position_of_touch_y);
    ctx.stroke();
